...
func cmdFunc(cmd *cobra.Command, args []string) {
	...
	for ctx.Err() == nil {
		...
		inst, err := ec2.GetInstance(ctx, cfg, localInstanceID)
		if err != nil {
	...
	logutil.S().Infow("found asg tag", "key", asgTagKey, "value", asgTagValue)
